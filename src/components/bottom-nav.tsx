...
import { Home, Stethoscope, Phone, MessageCircle, CalendarCheck } from 'lucide-react';
          ...
          {navLinks.map((link) => {
            ...
            return (
              <Link
                ...
                className={cn(
                  'flex flex-col items-center justify-center text-sm font-medium transition-colors w-1/5',
