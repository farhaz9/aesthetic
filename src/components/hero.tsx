  ...
  return (
    <section id="home" className="relative h-[80vh] min-h-[500px] w-full flex items-center justify-center text-center text-white p-0">
      ...
      <div className="relative z-10 container mx-auto px-4">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight bg-gradient-to-r from-yellow-400 via-red-500 to-purple-600 bg-clip-text text-transparent animate-typing overflow-hidden whitespace-nowrap border-r-4 border-r-white pr-2">
